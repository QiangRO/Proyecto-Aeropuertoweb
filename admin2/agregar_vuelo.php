        ...
        <h2 class="is-size-2">Nuevo producto</h2> -->
            <form action="guardar_producto.php" method="post">
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input required id="horasalida" class="input" type="text" placeholder="Hora Regreso" name="horasalida">
                    </div>
                </div>
                <div class="field">
                    <label for="horallegada">Hora Llegada</label>
                    <div class="control">
                        <input required id="horallegada" class="input" type="text" placeholder="Hora Llegada" name="horallegada">
                    </div>
                </div>
                <!-- <div class="field">
