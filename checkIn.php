    ...
    <div class="container">
        ...
        <div class="row2 row-bottom-padded-md">
            ...
            <div class="col-md-6 ">
                <div class="row2">
                    <div class="col-md-12">
                    <div class="row" style="padding-left: 250px; with: 1500px; ">
                        <div class="col-xxs-12 col-xs-6 mt alternate">
                            <div class="input-field">
                            <form id="contact-form" method="post" action="">
                                Codigo del avion:
                                <input style="padding-left: 250px; with: 1500px;" type="text" name="codigo" class="form-control" placeholder="Ingrese su codigo:" required>
                                    <br>Nombre del pasajero:
                                <input style="padding-left: 250px; with: 1500px;" type="text" name="nombre" class="form-control" placeholder="Ingrese su nombre:" required>
                                    <br>Apellido del pasajero:
                                <input style="padding-left: 250px; with: 1500px;" type="text" name="apellido" class="form-control" placeholder="Ingrese su apellido:" required>
                                    <br>
                            </div>
                        </div>
                            <div class="col-xs-12">
