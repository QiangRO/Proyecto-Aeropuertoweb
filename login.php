    ...
    <div class="container">
      <div class="card login-card">
        <div class="row no-gutters">
          <div class="col-md-5">
            <img src="images/loginimage.jpg" alt="login" class="login-card-img">
          </div>
          <div class="col-md-7">
            <div class="card-body">
              ...
              <p class="login-card-footer-text">¿Aun no tiene cuenta? <a href="registro.php">Registrate aqui.</a></p>
