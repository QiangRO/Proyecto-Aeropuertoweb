...
<div class="container">
					<center><div class="nav-header" style="padding: 30px;">
                        ...
                        <h1 class="tituloh2" style="color: #3683f7; padding-top:40px; ">PET CHECK</h1>
					</div></center>
				</div>
			</header>
    ...
    <?php
		...
		$registros = mysqli_query($conexion, "select codigo_vuelo, pasajero, peso, nombreM, documentacion from petcheck
        where codigo_vuelo='$_REQUEST[codigo_vuelo]'") or
         die ("Problemas en el select:" . mysqli_error($conexion));
		while ($reg = mysqli_fetch_array($registros)){
			echo(" <center> <p>-----------------------------------------------------------</p>
            Nombre del pasajero: ". $reg['pasajero'] . " <br>
            Nombre de la  mascota: ". $reg['nombreM'] . " <br>
            peso: ". $reg['peso'] . " <br>
            documentos que tiene: ". $reg['documentacion'] . " <br>
