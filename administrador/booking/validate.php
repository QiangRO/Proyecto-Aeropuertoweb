...
echo ("<a> PEDIR REF:</a> <span class='ref'>$order_ref</span>"); 	
echo("<ul><li>PROPIETARIO DE TICKET: ".$fullname."</li>
<li>DESTINO: ".$destination."</li>
<li>FECHA DE VIAJE: ".$traveldate."</li>
<li>CLASE DE VIAJE: ".$travelclass."</li>
<li>Identificación del asiento: ".$seats." of ".$all."</li>
<li>CANTIDAD DE PAGO: ".$amount." Via ".$paymethod." Transaction ID: ".$code."</li>
</ul>");
echo ("</div>");
$seats--;
}
