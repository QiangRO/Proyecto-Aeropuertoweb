...
function billing() {
	...
	$("#payment-info").html("Confirmar el pago del número de asientos de clase alta");
	return false;
...
function confirmdetails() {
	...
	$("#details").html("<ul><li>PROPIETARIO DE TICKET: " + fullname + "</li><li>DESTINO: " + destination + "</li><li>FECHA DE VIAJE: " + traveldate + "</li><li>CLASE DE VIAJE: " + travelclass + "</li><li>NUMERO DE ASIENTOS: " + seats + "</li><li>CANTIDAD DE PAGO: " + amount + " Via " + paymethod + " ID de transacción: " + code + "</li></ul>");
