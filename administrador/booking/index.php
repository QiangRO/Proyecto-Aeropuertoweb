...
<p>Solicitud de pedido Ref .. solo un segundo.</p>
<div id="proceed"></div>
</div>
</div>
<div class="ui attached bottom message">
<div class="ui horizontal divider">perdió su boleto?</div>
...
<button id="printbtn" class="ui button small blue">Reimprimir</button>
</form>
...
<script>
setTimeout(function(){document.getElementById("proceed").innerHTML="<a href='booking.php' class='ui button small green'>¡Hecho! Proceder</a> <a href='../admin/login.php' class='ui button small orange'>Admin Iniciar sesión</a> "},5000);
</script>
</body>
</html>